"""
Optuna hyperparameter tuning script — GARCH-LSTM (hybrid)
...
ONLY DIFFERENCE FROM tune_lstm.py: the GARCH conditional volatility series
...
the standalone LSTM script, per your finalized spec (item 4): hybrids reuse the
...
2. Run: python src/tuning/tune_garch_lstm.py   (from project root)
3. Best hyperparameters get saved to results/best_params/best_params_garch_lstm_<horizon>.json
...
SEQUENCE_LENGTH = 30   # fixed — same rationale as standalone LSTM script
...
STUDY_NAME = f"garch_lstm_{HORIZON}"
...
# ============================================================
# STEP 4: MODEL BUILDER (identical to standalone LSTM)
# ============================================================
...
# ============================================================
# STEP 5: OPTUNA OBJECTIVE (identical search space to standalone LSTM)
# ============================================================
